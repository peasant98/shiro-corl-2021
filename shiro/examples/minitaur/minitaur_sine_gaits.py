...
from shiro.envs.minitaur import base_minitaur_env
...
def ResetPoseExample(log_path=None):
  ...
  steps = 10000
  environment = base_minitaur_env.ShiroMinitaurGymEnv(
      urdf_version=base_minitaur_env.DERPY_V0_URDF_VERSION,
      render=True,
